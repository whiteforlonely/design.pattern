...
public class TimeUtils {
	...
	* @throws
	...
	public static long getVideoPlayTime(String time){
		...
		return (min * 60 + second) * 1000l;
	}
	
	public static String reverseVideoTime(long time){
	...
	public static String reverseAudioTime(int time){
		int hour = time/3600;
...
//		System.out.println(getVideoPlayTime("02:30"));
		System.out.println(reverseAudioTime(122));
	}
